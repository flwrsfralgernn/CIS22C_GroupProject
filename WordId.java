public class WordId {
    private String word;
    private int id;
    private static int assignedID = 0; // tracks amount of created objects with assigned Ids. Incremented after new
                                       // word is assigned Id.
     ...
     * @postcondition new WordID object is created with attribute word. ID is -1
     *                until assigned.
     */
     ...
     */
    public int getId() { // Use after getting wordId object from hashMap to get index in arraylist of
                         // bst.
        return id;
    }
    ...
    public void assignId() {
        // The id of the word is its index in the BST arraylist. Do not use if word
        // already has or had id.
        this.id = assignedID;
        assignedID++;
    }
     ...
     * Can be used with word with no ID to search for original using wordID
     * hashtable.
     * 
